...
const styles = {
    ...
    form: "flex flex-col gap-y-2 md:flex-row mb-12 p-0 rounded-full bg-[#0d5b1a2e]",
    ...
    modal: "fixed top-0 left-0 w-full h-full bg-[#000000c7] bg-opacity-50 flex justify-center items-center z-[1000]",
        ...
        <div className={styles.todoMain}>
            ...
            <div className={styles.todoApp}>
                <form onSubmit={handleAddTask} className={styles.form}>
                    <input type="text" id='task' name="newTask" ref={inputRef} placeholder="What do you need to do?" className={styles.input} />
